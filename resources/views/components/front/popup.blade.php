...
<path d="M18.3569 18.357L12.2192 12.2193" stroke="#323232" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <div class="popup__container" style="display: ">
        <h2 class="popup__title general-lackR">Biz sizga qo'ng'iroq qilamiz</h2>
        <!-- /.popup__title general-lackR -->
        <p class="popup__txt general-R">E'tibor bering, savdo bo'limining ish vaqti
            9:00 dan 21:00 gacha</p>
        <!-- /.popup__txt -->
        <form action="" class="popup__form">
            ...
            <p class="popup__txt general-R">E'tibor bering, savdo bo'limining ish vaqti
                9:00 dan 21:00 gacha</p>
            <!-- /.popup__txt -->
            <button type="submit" class="general-M">Buyurtma </button>
        </form>
        <!-- /.popup__form -->
    </div>
    {{--=========POPUP SUCCESS=========--}}
