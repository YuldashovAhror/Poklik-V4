                ...
                <form action="{{ route('voice.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="form-label" for="exampleFormControlInput1">Голос </label>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="exampleFormControlInput1" type="text" name="type_ru">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                                    <label class="form-label" for="exampleFormControlInput1">Тип UZ</label>
                                    <input class="form-control" id="exampleFormControlInput1" type="text" name="type_uz">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                                    <label class="form-label" for="exampleFormControlInput1">Тип EN</label>
                                    <input class="form-control" id="exampleFormControlInput1" type="text" name="type_en">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-xs btn-success" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $voice->id }}Edit"><i
                                                class="bx bx-pencil"></i></button>
                                        <div class="modal fade" id="exampleModalCenter{{ $voice->id }}Edit"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('voice.update', $voice) }}" method="post"
                                                            ...
                                                            <div class="card-body">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="mb-3">
                                                                            <label class="form-label"
                                                                                for="exampleFormControlInput1">Голос

                                                                            </label>

                                                                            <input class="form-control mt-1"
                                                                                id="exampleFormControlInput1"
                                                                                type="file" name="voice">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <div class="mb-3">
                                                                            <label class="form-label"
                                                                                for="exampleFormControlInput1">Тип
                                                                                RU</label>
                                                                            <input class="form-control"
                                                                                id="exampleFormControlInput1"
                                                                                type="text" name="type_ru"
                                                                                value="{{ $voice->type_ru }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-4">
                                        ...
                                        <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $voice->id }}"><i
                                                class="bx bx-trash"></i></button>
                                        <div class="modal fade" id="exampleModalCenter{{ $voice->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('voice.destroy', $voice->id) }}"
                                                            method="post">
                                                            @csrf
                                                            {{ method_field('delete') }}
