                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="exampleFormControlInput1" required type="file" name="photo2">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="col-6 text-center">
                                                                            <img style="height: 100px; width: 100px" src="{{ $category->photo }}">
                                                                        </div>
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="exampleFormControlInput1">Фото 2
                                                                        </label>
                                                                        <div class="col-6 text-center">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="exampleFormControlInput1">Название RU</label>
                                                                        <input class="form-control" id="exampleFormControlInput1" type="text" required name="name_ru" value="{{ $category->name_ru }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="exampleFormControlInput1">Название UZ</label>
                                                                        <input class="form-control" id="exampleFormControlInput1" type="text" required name="name_uz" value="{{ $category->name_uz }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="exampleFormControlInput1">Название EN</label>
                                                                        <input class="form-control" id="exampleFormControlInput1" type="text" required name="name_en" value="{{ $category->name_en }}">
                                                                    </div>
                                                                </div>
                                                            </div>
