    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <form action="{{ route('comment.store') }}" method="post" enccomment="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 50vw">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('comment.update', $comment) }}" method="post" enccomment="multipart/form-data">
                                                        @csrf
                                                        {{ method_field('put') }}
                                                        <div class="card-body">
                                                            <div class="row">
